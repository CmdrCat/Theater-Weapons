local att = {}
att.name = "bg_ar15sturdystock_sr338"
...
function att:attachFunc()
	...
	if CLIENT and self.AttachmentModelsVM and self.AttachmentModelsVM.bg_ar15sturdystock_sr338 then
		local ent

		ent = self.AttachmentModelsVM.bg_ar15sturdystock_sr338.ent
