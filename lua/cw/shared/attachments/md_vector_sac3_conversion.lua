...
if CLIENT then
	...
	att.description = {[1] = {t = "Steady-shooting variant dependent on whether it is dual / single-wielded. ", c = CustomizableWeaponry.textColors.COSMETIC},
					   ...
					   [3] = {t = "Increases damage to 50 / 32", c = CustomizableWeaponry.textColors.POSITIVE},
					   [4] = {t = "Decreases firerate to 600 / 923 RPM", c = CustomizableWeaponry.textColors.NEGATIVE},
					   [5] = {t = "Increases effective range to 31 / 22 M", c = CustomizableWeaponry.textColors.POSITIVE},
					   [6] = {t = "Decreases damage fall off to 28 / 37%", c = CustomizableWeaponry.textColors.POSITIVE},
					   [7] = {t = "Decreases reload speed to 1.5 / 2 s", c = CustomizableWeaponry.textColors.POSITIVE}}
end
