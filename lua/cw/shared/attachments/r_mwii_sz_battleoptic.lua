...
if CLIENT then
	att.displayIcon = surface.GetTextureID("vgui/atts/r_szbattleoptic")
	att.description = {[1] = {t = "A bulky reliable sight.", c = CustomizableWeaponry.textColors.POSITIVE}}
	
	att.reticle = "reticles/zoom/SZBattleOptic_reticle"
	att._reticleSize = 5
	...
	function att:drawReticle()
		...
		diff = self:getDifferenceToAimPos(self.BATPos, self.BATAng, 1)
