local att = {}
att.name = "doi_atow_m73"
att.displayNameShort = "M73 4x"
att.displayName = "M73 Weaver"
att.aimPos = {"M73Pos", "M73Ang"}
att.FOVModifier = 15
att.isSight = true
...
function att:drawRenderTarget()
		...
		if self.M82AxisAlign then
			local right, up, forward = ang:Right(), ang:Up(), ang:Forward()
			
			ang:RotateAroundAxis(right, self.M82AxisAlign.right)
			ang:RotateAroundAxis(up, self.M82AxisAlign.up)
			ang:RotateAroundAxis(forward, self.M82AxisAlign.forward)
		end
