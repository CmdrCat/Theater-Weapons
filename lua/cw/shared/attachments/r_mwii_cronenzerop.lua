...
if CLIENT then
	...
	[2] = {t = "For medium ranges.", c = CustomizableWeaponry.textColors.NEGATIVE},

    }
	local old, x, y, ang
	local reticle = surface.GetTextureID("reticles/zoom/CronenP_Reticle")
	
	att.zoomTextures = {{tex = surface.GetTextureID("reticles/zoom/CronenP_Reticle"), offset = {0, 0}}}
