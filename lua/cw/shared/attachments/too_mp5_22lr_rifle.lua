...
function att:attachFunc()
	...
	self.Trivia = {text = "The MP5 .22 LR Rifle is a civilian-legal, .22 LR variant of the MP5. Though semi-automatic, it boasts a very high cyclic rate, if your finger can keep up with it.", x = -500, y = -800}
...
function att:detachFunc()
	...
	self.FireSoundSuppressed = "CW_MP5_FIRE_SUPPRESSED"
	self.Primary.Ammo = "9x19MM"
	self.PrintName = "MP5A3"
	self.Trivia = {text = "This reliable submachine gun is the face of counter-terrorism due its successful usage by SAS operators in Operation Nimrod.", x = -500, y = -800}
