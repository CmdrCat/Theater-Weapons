...
if CLIENT then
	...
	SWEP.EoTechPos = Vector(-3.04, -2.388, 0.319)
	...
	SWEP.AttachmentModelsVM = {
		...
		["md_eotech"] = { type = "Model", model = "models/wystan/attachments/2otech557sight.mdl", bone = "weapon", rel = "", pos = Vector(0.268, 7.946, -14.818), angle = Angle(90, 0, -90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
