...
if CLIENT then
	...
	killicon.Add( "doi_atow_m1918a2", "vgui/inventory/killicons/weapon_bar", Color(255, 120, 40, 0))
...
["+reload"] = {header = "Ammo", offset = {450, 300}, atts = {"am_atow_light", "am_atow_lowvel", "am_atow_ap"}}}
...
SWEP.RecoilToSpreadFast = -0.25
SWEP.RecoilToSpreadSlow = -0.5
