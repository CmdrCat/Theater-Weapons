...
--	SWEP.MuzzleAtachment = 1
	...
	["md_cmore"] = {[1] = Vector(5.25, -2, 2.5), [2] = Vector(0,0,45)},
	["md_trijicon"] = {[1] = Vector(5.25, -2, 2.5), [2] = Vector(0,0,45)},
	["md_microt1"] = {[1] = Vector(5.25, 0, 2.5), [2] = Vector(0,0,45)},
	["too_reflex_romeo4t"] = {[1] = Vector(5.25, -3, 2.5), [2] = Vector(0,0,45)},
	["md_aimpoint"] = {[1] = Vector(5.25, -1.25, 2.5), [2] = Vector(0,0,45)},
	["too_reflex_exps"] = {[1] = Vector(5.25, -2, 2.5), [2] = Vector(0,0,45)},
	["corioenforcer"] = {[1] = Vector(5.25, -3, 2.5), [2] = Vector(0,0,45)},
	["md_schmidt_shortdot"] = {[1] = Vector(5.25, -0.25, 2.5), [2] = Vector(0,0,45)},
	["md_elcan"] = {[1] = Vector(3.886, 0, 0.29), [2] = Vector(-0.1, 0, 0)},
	["md_acog_fixed"] = {[1] = Vector(3.897, 0, -0.027), [2] = Vector(0, 0, 0)},
	["md_nightforce_nxs"] = {[1] = Vector(5.25, -0.25, 2.5), [2] = Vector(0,0,45)}
	}
