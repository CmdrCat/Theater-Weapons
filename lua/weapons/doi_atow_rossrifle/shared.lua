...
if CLIENT then
	...
	SWEP.PrintName = "Ross rifle"
	SWEP.CSMuzzleFlashes = true
	SWEP.UseHands = true
	
	SWEP.SelectIcon = surface.GetTextureID("vgui/inventory/weapon_springfield")
	killicon.Add( "doi_atow_m1903a3", "vgui/inventory/killicons/weapon_springfield", Color(255, 120, 40, 0))
	...
	["nah"] = {
	["ValveBiped.Bip01_L_Forearm"] = { scale = Vector(1, 1, 1), pos = Vector(-.75, .0, .6), angle = Angle(0, 0, 20) },
...
["+reload"] = {header = "Ammo", offset = {320, 180}, atts = {"am_magnum", "am_matchgrade", "am_atow_lowvel", "am_atow_heavy", "am_atow_ap"}}}
...
SWEP.ViewModel		= "models/khrcw2/doipack/rossrifle.mdl"
...
SWEP.GlobalDelayOnShoot = 60/68
SWEP.GlobalDelayOnShootSlow = 60/60
SWEP.GlobalDelayOnShootFast = 60/74
