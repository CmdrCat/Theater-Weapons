...
if CLIENT then
	...
	killicon.Add( "doi_atow_m1garand", "vgui/inventory/killicons/weapon_m1garand", Color(255, 120, 40, 0))
	...
	["bipod"] = {
	["ValveBiped.Bip01_L_Forearm"] = { scale = Vector(1, 1, 1), pos = Vector(-.75, .0, -.1), angle = Angle(0, 0, 5) },
	...
	["ValveBiped.Bip01_L_Forearm"] = { scale = Vector(1, 1, 1), pos = Vector(-.75, .0, -.1), angle = Angle(0, 0, 5) },
	["L Hand"] = { scale = Vector(1, 1, 1), pos = Vector(0, .40, -.5), angle = Angle(5, 2, -5) },
	["L Clavicle"] = { scale = Vector(1, 1, 1), pos = Vector(1.5, .1, 0), angle = Angle(0, 0, 0) },
