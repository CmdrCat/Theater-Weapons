...
if CLIENT then
	...
	SWEP.AlternativePos = Vector(-4, -1, 1)
	SWEP.AlternativeAng = Vector(0, -15, 0)
	
	SWEP.SelectIcon = surface.GetTextureID("vgui/inventory/weapon_kabar")
	killicon.Add( "doi_atow_knifeus", "vgui/inventory/killicons/weapon_kabar", Color(255, 120, 40, 0))
end
...
SWEP.Sounds = {
	hitcenter1 = {{time = 0.05, sound = "DOIMELEE_SWING"}},
	hitcenter2 = {{time = 0.15, sound = "DOIMELEE_SWING"}},
...
SWEP.PrimaryAttackRange = 55
SWEP.SecondaryAttackRange = 55

SWEP.HolsterTime = 0.25
SWEP.DeployTime = 0.3

SWEP.PrimaryAttackImpactTime = 0.075
SWEP.PrimaryAttackDamageWindow = 0.15

SWEP.SecondaryAttackImpactTime = 0.15
