...
if CLIENT then
	...
	SWEP.ThermalPos = Vector(2.02, -2.8, 0.4)
	...
	SWEP.AttachmentModelsVM = {
		...
		["md_thermal"] = { type = "Model", model = "models/bunneh/elcan.mdl", bone = "smdimport", rel = "", pos = Vector(0.36, -2.2, 3.18), angle = Angle(0, 180, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 0)},
...
SWEP.Attachments = {[1] = {header = "Sight", offset = {200, -400},  atts = {"md_microt1", "md_cmore", "md_reflex", "md_trijicon", "md_aimpoint", "md_elcan", "md_acog_fixed", "md_uecw_csgo_acog", "md_thermal"}, exclusions = {bg_ris = true, bg_longbarrel = true}},
