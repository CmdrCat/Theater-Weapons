...
if CLIENT then
	...
	SWEP.PrintName = "Spade - U.S."
	SWEP.CSMuzzleFlashes = true
	SWEP.UseHands = true
	
	SWEP.DisableSprintViewSimulation = false
	
	SWEP.CustomizePos = Vector(3.6, -1, -2.661)
	SWEP.CustomizeAng = Vector(13.477, 22.809, 5.477)
	...
	SWEP.SelectIcon = surface.GetTextureID("vgui/inventory/weapon_etoolus")
	killicon.Add( "doi_atow_etoolus", "vgui/inventory/killicons/weapon_etoolus", Color(255, 120, 40, 0))
end

SWEP.Attachments = {[1] = {header = "Optic", offset = {800, 0}, atts = {"btk_atow_coltscope"}}}

SWEP.Animations = {
	slash_primary = {"swing_left_miss"},
	slash_secondary = {"base_attack_kill"},
	draw = "base_draw"
}

SWEP.Sounds = {
	swing_left_miss = {{time = 0.125, sound = "DOIMELEE_SWING"}},
	base_attack_kill = {{time = 0.25, sound = "DOIMELEE_SWING"}},
...
SWEP.PrimaryAttackDamage = {30, 30}
SWEP.SecondaryAttackDamage = {50, 50}
...
SWEP.PrimaryAttackImpactTime = 0.18
SWEP.PrimaryAttackDamageWindow = 0.1

SWEP.SecondaryAttackImpactTime = 0.335
