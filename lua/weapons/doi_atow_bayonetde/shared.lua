...
if CLIENT then
	...
	killicon.Add( "doi_atow_bayonetde", "vgui/inventory/killicons/weapon_k98bayonet", Color(255, 120, 40, 0))
end
...
SWEP.PrimaryAttackRangeSafe = 0
SWEP.SecondaryAttackRangeSafe = 0

SWEP.PrimaryAttackRangeReady = 60
SWEP.SecondaryAttackRangeReady = 60
