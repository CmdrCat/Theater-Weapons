...
if CLIENT then
	...
	killicon.Add( "doi_atow_mp40", "vgui/inventory/killicons/weapon_mp40", Color(255, 120, 40, 0))
...
SWEP.WM = "models/weapons/w_smg_mp5.mdl"
