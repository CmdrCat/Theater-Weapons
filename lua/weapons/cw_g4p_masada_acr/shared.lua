...
--	SWEP.CustomizeAng = Vector(27.256, -50.713, -29.239)
	...
	SWEP.AttachmentModelsVM = {
		...
		["md_elcan"] = { type = "Model", model = "models/bunneh/elcan.mdl", bone = "Masada_body", rel = "", pos = Vector(-0.28, -7.2, -3.66), angle = Angle(180, 180, 180), adjustment = {min = -7.55, max = -4.5, axis = "y", inverseOffs1etCalc = true}, size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 0)},
		["md_acog"] = {model = "models/wystan/attachments/2cog.mdl", bone = "Masada_body", pos = Vector(-0.38, -7.2, -4.8), angle = Angle(0, 0, 0), adjustment = {min = -8.14, max = -5.68, axis = "y", inverseOffs1etCalc = true}, size = Vector(1, 1, 1)},
		["md_uecw_csgo_acog"] = { type = "Model", model = "models/gmod4phun/csgo/eq_optic_acog.mdl", bone = "Masada_Body", rel = "", pos = Vector(0, -9.601, -3.5), angle = Angle(0, -90, 0), adjustment = {min = -10.35, max = -7.9, axis = "y", inverseOffs1etCalc = true}, size = Vector(1, 1, 1)},
		["md_uecw_csgo_556"] = { type = "Model", model = "models/gmod4phun/csgo/eq_optic_sig.mdl", bone = "Masada_Body", rel = "", pos = Vector(0, -1.8, 0.74), angle = Angle(0, -90, 0), adjustment = {min = -2.21, max = 0.87, axis = "y", inverseOffs1etCalc = true}, size = Vector(0.8, 0.8, 0.8)},
		["md_thermal"] = { type = "Model", model = "models/bunneh/elcan.mdl", bone = "Masada_body", rel = "", pos = Vector(-0.28, -7.2, -3.66), angle = Angle(180, 180, 180), adjustment = {min = -7.55, max = -4.5, axis = "y", inverseOffs1etCalc = true}, size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 0)},
		["md_nightforce_nxs"] = {model = "models/cw2/attachments/l96_scope.mdl", bone = "Masada_body", rel = "", pos = Vector(-0.136, -0.5, 2.065), angle = Angle(0, -90, 0),  adjustment = {min = -0.94, max = 1.75, axis = "y", inverseOffs1etCalc = true}, size = Vector(1, 1, 1)},
		["md_ballistic"] = { type = "Model", model = "models/bunneh/scope01.mdl", bone = "Masada_body", rel = "", pos = Vector(-1.315, -10.2, 1.52), angle = Angle(0, -90, 0), adjustment = {min = -11.2, max = -6.9, axis = "y", inverseOffs1etCalc = true}, size = Vector(1.039, 1.039, 1.039), color = Color(255, 255, 255, 255)},
		--Lasers
