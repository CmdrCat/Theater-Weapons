...
if CLIENT then
	...
	SWEP.PrintName = "Bren MkII"
	SWEP.CSMuzzleFlashes = true
	SWEP.UseHands = true
	
	SWEP.SelectIcon = surface.GetTextureID("vgui/inventory/weapon_bren_mk2")
	killicon.Add( "doi_atow_bren", "vgui/inventory/killicons/weapon_bren_mk2", Color(255, 120, 40, 0))
	...
	["bipod"] = {
	["ValveBiped.Bip01_L_Forearm"] = { scale = Vector(1, 1, 1), pos = Vector(-.75, .0, .2), angle = Angle(0, 0, 0) },
...
SWEP.Recoil = .85
SWEP.BipodRecoilModifier = 0.1 --0.1 -- = 0 --0
 -- = 1.1
