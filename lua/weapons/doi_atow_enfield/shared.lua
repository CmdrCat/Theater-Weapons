...
if CLIENT then
	...
	killicon.Add( "doi_atow_enfield", "vgui/inventory/killicons/weapon_enfield", Color(255, 120, 40, 0))
	...
	["nah"] = {
	["ValveBiped.Bip01_L_Forearm"] = { scale = Vector(1, 1, 1), pos = Vector(-.75, .0, -.1), angle = Angle(0, 0, 15) },
