...
if CLIENT then
	...
	SWEP.SelectIcon = surface.GetTextureID("vgui/awm")
	killicon.Add("cw_g4p_awm", "vgui/killicons/awm", Color(255, 120, 40, 0))
...
--	SWEP.CustomizeAng = Vector(27, -50, -30)
	...
	SWEP.AttachmentModelsVM = {
		...
		["md_foregrip"] = { type = "Model", model = "models/wystan/attachments/foregrip1.mdl", bone = "Base", rel = "", pos = Vector(-0.362, -5.115, -4.128), angle = Angle(0, 0, 0), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 0), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
