...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		...
		["md_insight_x2"] = {model = "models/cw2/attachments/pistollaser.mdl", bone = "weapon", pos = Vector(0, 1.36, 1.85), angle = Angle(0, 90, 0), size = Vector(0.12, 0.12, 0.12)}
	}
...
SWEP.Attachments = {[1] = {header = "Sight", offset = {500, -300},  atts = {"md_docter", "md_nightforce_nxs"}},
	[2] = {header = "Barrel", offset = {-450, -200},  atts = {"bg_ber_babybull"}},
	[3] = {header = "Laser", offset = {-600, 330}, atts = {"md_insight_x2"}},
	[4] = {header = "Technique", offset = {900, 600}, atts = {"doi_atow_onehand"}},
	[5] = {header = "Conversion", offset = {80, 450}, atts = {"cw_500nitroexpress"}},
	["+reload"] = {header = "Ammo", offset = {1000, 100}, atts = {"am_reducedpowderload", "am_matchgrade", "am_atow_lowvel", "am_atow_heavy", "am_atow_ap", "am_snakeshot"}}}
