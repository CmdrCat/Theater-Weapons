...
if CLIENT then
	...
	SWEP.PrintName = "Bayonet - Lee-Enfield"
	...
	SWEP.WM = "models/khrcw2/doipack/w_enfieldbayonet.mdl"
	...
	killicon.Add( "doi_atow_bayonetcw", "vgui/inventory/killicons/weapon_enfield_bayonet", Color(255, 120, 40, 0))
end
...
SWEP.Sounds = {
	...
	slash_2 = {{time = 0.05, sound = "DOIMELEE_SWING"}},
...
SWEP.FireAnimSpeed = 1.1
SWEP.SpeedDec = 0

SWEP.ViewModelFOV	= 75 // 65
SWEP.ViewModelFlip	= false
SWEP.ViewModel = "models/khrcw2/doipack/enfieldbayonet.mdl"
SWEP.WorldModel = "models/khrcw2/doipack/w_enfieldbayonet.mdl"
...
SWEP.SecondaryAttackImpactTime = 0.175
...
function SWEP:IndividualThink()
	if (SP and SERVER) or IsFirstTimePredicted() then
		...
		if self.attackDamageTime and ct > self.attackDamageTime and ct < self.attackDamageTime + self.attackDamageTimeWindow then
			...
			self.Owner:ViewPunch(Angle(0, -.25, -.1))
