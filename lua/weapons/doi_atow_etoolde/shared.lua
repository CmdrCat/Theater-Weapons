...
if CLIENT then
	...
	SWEP.SelectIcon = surface.GetTextureID("vgui/inventory/weapon_etoolde")
	killicon.Add( "doi_atow_etoolde", "vgui/inventory/killicons/weapon_etoolde", Color(255, 120, 40, 0))
end


SWEP.Animations = {
	slash_primary = {"swing_left_miss"},
	slash_secondary = {"swing_hard"},
	draw = "base_draw"
}

SWEP.Sounds = {
	swing_left_miss = {{time = 0.125, sound = "DOIMELEE_SWING"}},
	swing_hard = {{time = 0.25, sound = "DOIMELEE_SWING"}},
...
SWEP.SecondaryAttackDamage = {80, 80}
