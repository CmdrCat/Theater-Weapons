...
if CLIENT then
	...
	SWEP.AttachmentModelsVM = {
		...
		["md_bipod"] = { type = "Model", model = "models/wystan/attachments/bipod.mdl", bone = "body", rel = "", pos = Vector(0.055, 9.251, -1.08), angle = Angle(0, -180, 0), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 0), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 1} },
		--Magazines
