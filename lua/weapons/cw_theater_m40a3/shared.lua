...
if CLIENT then
	...
	SWEP.EoTechPos = Vector(-3.161, -2.695, 0.409)
...
--	SWEP.AimViewModelFOV = 60
	...
	SWEP.AttachmentModelsVM = {
		...
		["md_eotech"] = { type = "Model", model = "models/wystan/attachments/2otech557sight.mdl", bone = "weapon", rel = "", pos = Vector(0.289, 8.387, -9.591), angle = Angle(90, 0, -90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
