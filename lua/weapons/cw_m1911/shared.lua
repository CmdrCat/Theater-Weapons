...
if CLIENT then
	...
	SWEP.IconLetter = "f"
	SWEP.SelectIcon = surface.GetTextureID("vgui/m1911")
	killicon.Add("cw_m1911", "vgui/killicons/m1911", Color(255, 120, 40, 0))
	...
	SWEP.ShellPosOffset = {x = -5, y = 0, z = -2}
...
SWEP.Trivia = {text = "A handgun design so legendary, it is still used over a decade later.", x = -400, y = -450}
