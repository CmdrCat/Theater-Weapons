...
if CLIENT then
	...
	SWEP.NXSPos = Vector(-2.305, -3, 0.55)
    SWEP.NXSAng = Vector(0, 0, 0)

	SWEP.BackupSights = {["md_nightforce_nxs"] = {[1] = Vector (-5, 5, 1.5), [2] = Vector(0, 0, -65)}
	}
	...
	["md_rail"] = { type = "Model", model = "models/wystan/attachments/rail.mdl", bone = "MG42_LID", rel = "", pos = Vector(-0.05, -1., -1.25), angle = Angle(0, 90, 0), size = Vector(0.009, 0.009, 0.009)},
	 ["md_nightforce_nxs"] = {model = "models/cw2/attachments/l96_scope.mdl", bone = "MG42_LID", rel = "", pos = Vector(-0.4, -1.864, 1.583), angle = Angle(0, -90, 0), size = Vector(1.4, 1.4, 1.4)}
	}
...
[4] = {header = "Fire Control", offset = {850, 350}, atts = {"doi_atow_burstconv", "doi_atow_mg3conv", "doi_atow_dlt19x"}},
...
function SWEP:IndividualThink()
	...
	if self.ActiveAttachments.doi_atow_dlt19x then
		self.EffectiveRange = 9999 * 39.37
		self.DamageFallOff = 0
